...
?>
        ...
        <section class="grey-text text-darken-3">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col s12 center">
                            <button class="btn-large waves-effect waves-light blue darken-2" type="submit" form="order-search-form">Search<i class="fa fa-search right" aria-hidden="true"></i></button>
                        </div>
                    </div>
