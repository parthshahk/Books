...
?>
        ...
        <!-- Social -->
        <section class="purple darken-1 social-icons">
            <div class="row center">
                ...
                <div class="col s12">
                    ...
                    <a target="_blank" href="mailto:malgadibooks@gmail.com"><i class="fa fa-envelope-o"></i></a>
            ...
            <div class="row center">
                ...
                <div class="col s12">
                    <a target="_blank" href="https://github.com/malgadi-nadiad/Books"><i class="fa fa-github"></i></a>
                </div>
                <div class="col s12">
                    <a class="github-button" href="https://github.com/malgadi-nadiad/books/fork" data-icon="octicon-repo-forked" data-size="large" data-show-count="true" aria-label="Fork malgadi-nadiad/books on GitHub">Fork</a>
                    <a class="github-button" href="https://github.com/malgadi-nadiad/books/issues" data-icon="octicon-issue-opened" data-size="large" data-show-count="true" aria-label="Issue malgadi-nadiad/books on GitHub">Issue</a>
                </div>
